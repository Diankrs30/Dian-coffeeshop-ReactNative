...
import icon_admin from '../../assets/images/icon_admin.png';
  ...
  return (
    <ScrollView>
      <View style={styles.content_all}>
        ...
        {profile.role === 'admin' ? (
          <View style={styles.content_chatAdmin}>
            ...
            <View style={styles.chat_admin}>
              <Text style={styles.text_admin}>
                ...
                You will get a cup of coffee free only at 7 to 9 AM. If you
                still have some questions to ask, let me know. Have a wonderful
                day!
              </Text>
        ...
        {profile.role === 'admin' ? (
          <View style={styles.content_timeAdmin}>
            <Text style={styles.time}>12.00 PM</Text>
          </View>
        ) : (
          <View style={styles.content_time}>
            <Text style={styles.time}>12.00 PM</Text>
          </View>
        )}
        {profile.role === 'admin' ? (
          <View style={styles.content_chatSecAdmin}>
            <View style={styles.chatSec_admin}>
              <Text style={styles.textSec_admin}>
                Hey, what beans do you use for making cold brew? Can I request
                the beans?
              </Text>
          ...
          <View style={styles.content_chatSec}>
        ...
        {profile.role === 'admin' ? (
          <View style={styles.content_timeSecAdmin}>
            <Text style={styles.time}>12.00 PM</Text>
          </View>
        ) : (
          <View style={styles.content_timeSec}>
            <Text style={styles.time}>12.00 PM</Text>
          </View>
        )}
        {profile.role === 'admin' ? (
        ...
        {profile.role === 'admin' ? (
          <View style={styles.content_chatSecAdmin}>
            <View style={styles.chatFour_admin}>
              <Text style={styles.textSec_admin}>
                I want arabica for the beans, thank you.
              </Text>
              <View style={styles.content_check} />
            </View>
            <Image source={icon_admin} style={styles.imgsec_admin} />
